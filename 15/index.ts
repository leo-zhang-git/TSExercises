...
export class ObjectManipulator<T> {
    ...
    public constructor(protected obj: T) {}

    public set<K extends string, V>(key: K, value: V) {
        return new ObjectManipulator({...this.obj, [key]: value} as unknown as (T & {[NK in K]: V})) 
    }
    ...
    public delete<K extends keyof T>(key: K) :ObjectManipulator<Omit<T, K>>{
        ...
        console.log("new obj", new ObjectManipulator(newObj))
